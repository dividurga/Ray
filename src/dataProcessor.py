...
while True:
    ...
    responseTwo = requests.get(requestTwo_url)
    if response.status_code == 200 or responseTwo.status_code == 200:
        ...
        requests.get(updateFour_url + str(recommendedSPF))
